...
const salesPagination = reactive(new OffsetPagination<SalesType>(
  ...
  [
    new EnumFilter('type', 'Sales.type', () => Object.keys(SalesEnumType).map(key => { return { value: key, label: key } }))
  ],
