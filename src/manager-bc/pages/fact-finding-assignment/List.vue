...
const viewSummary = async () => {
  ...
  const response = await managerRepository.getUser()
    .executeManagerGraphqlQuery<ResponseType>([
      {
        operation: { name: "viewFactFindingAssignmentCount", alias: "customerAssignmentCount" },
        variables: {},
        fields: []
      },
      {
        operation: { name: "viewFactFindingAssignmentCount", alias: "newAssignmentCount" },
        variables: {
      ...
      {
        operation: { name: "viewFactFindingAssignmentCount", alias: "idleAssignmentCount" },
        variables: {
      ...
      {
        operation: { name: "viewFactFindingAssignmentCount", alias: "activeAssignmentCount" },
        variables: {
          activeFilters: {
            type: "[FilterInput]", name: "filters",
            value: [{ column: "FactFindingAssignment.status", value: CustomerAssignmentStatus.ACTIVE }]
          }
        },
        fields: []
      },
