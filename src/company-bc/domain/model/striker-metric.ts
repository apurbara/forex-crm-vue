...
export default class StrikerMetric {
  id?: string;
  disabled?: boolean;
  ...
  constructor(data: StrikerMetricType = {}) {
    this.load(data);
  }
  load(data: StrikerMetricType) {
