...
export default class GreeterMetric {
  id?: string;
  disabled?: boolean;
  ...
  constructor(data: GreeterMetricType = {}) {
    this.load(data);
  }
  load(data: GreeterMetricType) {
