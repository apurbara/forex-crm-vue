  ...
  <div class="page-section">
    ...
    <div class="page-section ma-0">
      <v-tabs v-model="tab" fixed-tabs>
        <v-tab value="new-assignment"
          >New<v-badge inline rounded="sm" :content="newAssignmentCount" color="warning"
        /></v-tab>
        <v-tab value="idle-assignment"
          >Idle<v-badge inline rounded="sm" :content="idleAssignmentCount" color="error"
        /></v-tab>
        <v-tab value="pending-closing"
          >Closing<v-badge
            inline
            rounded="sm"
            :content="pendingClosingRequestAssignmentCount"
            color="primary"
        /></v-tab>
        <v-tab value="pending-recycle"
          >Recycling<v-badge
            inline
            rounded="sm"
            :content="pendingRecyleRequestAssignmentCount"
            color="primary"
        /></v-tab>
        <v-tab value="active-assignment"
          >Active<v-badge inline rounded="sm" :content="activeAssignmentCount" color="grey"
        /></v-tab>
        <v-tab value="good-fund"
          >Good Fund<v-badge inline rounded="sm" :content="goodFundAssignmentCount" color="success"
        /></v-tab>
        <v-tab value="all-assignment"
          >All<v-badge inline rounded="sm" :content="customerAssignmentCount" color="grey"
        /></v-tab>
      </v-tabs>
    ...
    },
    {
      ...
      variables: {
        goodFundFilters: {
          ...
          name: "filters",
          value: [
            { column: "CustomerAssignment.status", value: CustomerAssignmentStatus.GOOD_FUND },
          ],
        },
      },
      fields: [],
