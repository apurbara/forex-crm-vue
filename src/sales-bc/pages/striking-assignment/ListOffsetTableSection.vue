    ...
    <v-table height="402px" density="compact" style="width: 100%;" class="datatable">
      ...
      <tbody>
        ...
        <tr v-else v-for="(customerAssignment, index) in customerAssignmentPagination.resultList"
          ...
          <td><v-rating disabled :length="3" :size="16" :model-value="customerAssignment.customer?.rating" active-color="primary" /></td>
...
defineProps<{ customerAssignmentPagination: OffsetPagination<StrikingAssignmentType> }>()
