<template>
  ...
  <GreeterDashboardMetricComponent />
...
import GreeterDashboardMetricComponent from "./GreeterDashboardMetricComponent.vue";
...
const toAssignmentPage = (tab: string) => router.push(`/sales-greeting-assignment/?tab=${tab}`)
