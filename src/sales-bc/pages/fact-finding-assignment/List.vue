...
const viewSummary = async () => {
  ...
  const response = await salesRepository.getUser()
    .executeSalesGraphqlQuery<ResponseType>([
      {
        operation: { name: "totalFactFindingAssignment", alias: "customerAssignmentCount" },
        variables: {},
        fields: []
      },
      {
        operation: { name: "totalFactFindingAssignment", alias: "newAssignmentCount" },
        variables: {
      ...
      {
        operation: { name: "totalFactFindingAssignment", alias: "idleAssignmentCount" },
        variables: {
      ...
      {
        operation: { name: "totalFactFindingAssignment", alias: "activeAssignmentCount" },
        variables: {
          activeFilters: {
            type: "[FilterInput]", name: "filters",
